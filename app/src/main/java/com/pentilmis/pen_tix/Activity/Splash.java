...
import com.pentilmis.pen_tix.Activity.MainActivity.MainActivity;
import com.pentilmis.pen_tix.Utility.AppPreference;
...
import com.pentilmis.pen_tix.Return.Genre.Genre;
        ...
        if (appPreference.getFirstRun())
        {
            compositeDisposable.add(api.genre(BuildConfig.TMDB_API_KEY).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Consumer<ReturnGenre>() {
                ...
                public void accept(ReturnGenre returnGenre) throws Exception {
                        ...
                        com.pentilmis.pen_tix.DatabaseGenre.Genre genre;
                        for (int i =0 ; i<genres.size();i++)
                        {
                            genre = new com.pentilmis.pen_tix.DatabaseGenre.Genre();
